...
## Created a student email variable to reference in other files##
...
def student_create():
    if request.method == 'GET':
        ...
        student = Student(first_name=first_name, last_name=last_name, major_id=major_id, student_email=student_email,
...
## Added student email to be able to update a new email entry ##
